...
class pdarray:
    ...
    def sum(
        ...
        numpy_scalar or pdarray
            boolean if axis is omitted, in which case operation is done over entire array
    ...
    def reshape(self, *shape):
        ...
        >>> a.reshape((3,2))
        array([array([3 2]) array([1 1]) array([2 3])])
        >>> a.reshape(3,2)
        array([array([3 2]) array([1 1]) array([2 3])])
        >>> a.reshape((6,1))
        array([array([3]) array([2]) array([1]) array([1]) array([2]) array([3])])
